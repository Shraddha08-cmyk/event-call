              ...
              <div className="portfolioSec mb-40">
                <div className="portfolioTop">
                  ...
                  <div className="rightportfolio">
                    <h2>About Us</h2>
                    <p>
                      EventCall is a comprehensive event planning platform
                      designed to simplify and enhance the process of organizing
                      any event. Whether you’re planning a wedding, a corporate
                      function, a birthday party, or any other special occasion,
                      EventCall provides all the tools and resources you need to
              ...
              <div className="portfolioSec mb-40">
                <div className="portfolioTop">
                  ...
                  <div className="rightportfolio">
                    ...
                    <p>
                      Our platform features an extensive vendor directory where
                      you can explore a curated list of top-rated professionals
                      across various categories. Whether you need a wedding
                      planner, photographer, caterer, or decorator, EventCall
                      provides detailed vendor profiles with essential
                      information, including services, pricing, availability,
                      and customer reviews. This transparency allows you to make
                      informed decisions and choose the right vendors for your
                      event.
                    </p>
                  </div>
                </div>
                    ...
                    <div className="android-network">
                      ...
                      <div className="bullet-section nlp-bullet">
                        ...
                        <p>
                          ...
                          streamline your planning process, ensuring a smooth
